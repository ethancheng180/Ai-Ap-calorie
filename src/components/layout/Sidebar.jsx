...
import { Home, PlusCircle, Settings, PieChart, Moon, Sun } from 'lucide-react';
...
export default function Sidebar() {
    ...
    const navItems = [
        ...
        { icon: PieChart, label: 'Analytics', path: '/analytics' }, // Pointing to dashboard or specific analytics page
    ...
    return (
        <aside style={{
            ...
            <div style={{ marginTop: 'auto', paddingTop: 'var(--space-4)', borderTop: '1px solid var(--color-bg-tertiary)' }}>
                <button
                    onClick={toggleTheme}
                    style={{
                        display: 'flex',
